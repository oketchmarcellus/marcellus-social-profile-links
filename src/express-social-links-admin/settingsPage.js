...
const SettingsPage = () => {
	...
	const handleSave = async () => {
		...
		try {
			...
			createSuccessNotice(
				__( 'Settings saved successfully!', 'express-social-links' ),
				{
					type: 'snackbar',
				}
			);
	...
	if ( ! socialData ) {
		return (
			<div className="welcome-panel" style={ { padding: '20px' } }>
				{ __( 'Loading settings...', 'express-social-links' ) }
			</div>
		);
	}
	...
	const tabs = [
		{
			...
			title: (
				<div className="tab-label">
					<span>
						{ __( 'SOCIAL LINKS', 'express-social-links' ) }
					</span>
		...
		},
		{
			...
			title: (
				<div className="tab-label">
					<span>
						{ __( 'GLOBAL SETTINGS', 'express-social-links' ) }
					</span>
					<Dashicon
						icon="admin-generic"
		...
		},
		{
			...
			title: (
				<div className="tab-label">
					<span>{ __( 'ABOUT', 'express-social-links' ) }</span>
	...
	return (
		<div className="wrap">
			...
			<Panel className="express-socials-panel">
				<TabPanel
					className="express-socials-tabs"
							...
							<div style={ { flex: 1, padding: '24px 10px' } }>
								{ tab.name === 'socials' && (
									<Flex
										align="start"
										gap={ 6 }
										className="express-socials-responsive-flex"
									>
				...
				<Flex
					justify="flex-end"
					className="express-socials-footer-actions"
				>
					<Button
						variant="primary"
						isBusy={ isSaving }
