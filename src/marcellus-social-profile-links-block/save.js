...
export default function save( { attributes } ) {
	...
	const socialDataPayload = {
		...
		showHideSocials:
			attributes.showHideSocials !== undefined
				...
				: true,
		showText:
			attributes.showText !== undefined ? attributes.showText : true,
		hasBorder:
			attributes.hasBorder !== undefined ? attributes.hasBorder : true,
	...
	return (
		<div
			{ ...blockProps }
			className="marcellus-social-profile-links-item-container"
