...
// SEC HARDENING
$marcellus_social_profile_links_security_file = plugin_dir_path( __FILE__ ) . 'includes/sanitizer.php';
if ( file_exists( $marcellus_social_profile_links_security_file ) ) {
    require_once $marcellus_social_profile_links_security_file;
}

// LOAD DEFAULTS AND GENERATOR FUNCTION
$marcellus_social_profile_links_defaults_file = plugin_dir_path( __FILE__ ) . 'includes/defaults.php';
if ( file_exists( $marcellus_social_profile_links_defaults_file ) ) {
    require_once $marcellus_social_profile_links_defaults_file;
}
...
function marcellus_social_profile_links_enqueue_admin_assets( $hook ) {
    ...
    $asset_path = plugin_dir_path( __FILE__ ) . 'build/marcellus-social-profile-links-admin/index.asset.php';
    ...
    if ( file_exists( $asset_path ) ) {
        ...
        wp_enqueue_script(
            ...
            plugins_url( 'build/marcellus-social-profile-links-admin/index.js', __FILE__ ),
            $assets['dependencies'], 
            $assets['version'],
            true 
        );
        ...
        if ( file_exists( plugin_dir_path( __FILE__ ) . 'build/marcellus-social-profile-links-admin/index.css' ) ) {
            wp_enqueue_style(
                'marcellus-social-profile-links-admin-styles',
                plugins_url( 'build/marcellus-social-profile-links-admin/index.css', __FILE__ ),
                array(),
                $assets['version']
            );
        }
